...
const Aside = () => {
	return (
		<aside className="w-1/4 flex h-screen" aria-label="Sidebar">
			<div className="overflow-y-auto  py-4 px-3 bg-gray-50 dark:bg-gray-800 w-full">
